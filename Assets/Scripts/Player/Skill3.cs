...
public class Skill3 : MonoBehaviour
{
   ...
   // public string alpha;
    ...
    {
        if (Input.GetKeyDown(KeyCode.Alpha3) && !PlayerControl.instance.isUnbeatable && !PlayerControl.instance.speedUp && !PlayerControl.instance.berserker && PlayerControl.instance.hasWeapon() != null)
        {
            coolingTimer = timer;
            currentTime = 0.0f;
